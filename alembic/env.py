...
from sqlalchemy import pool,create_engine, exc

from alembic import context

from codeits.sys.SysEnv import SysEnv
...
# custom:aescobar
config.set_main_option('sqlalchemy.url', SysEnv.get('SQLALCHEMY_DATABASE_URI'))
...
def create_db_if_not_exists():
    ...
    db_uri      = SysEnv.get('SQLALCHEMY_DATABASE_URI')
